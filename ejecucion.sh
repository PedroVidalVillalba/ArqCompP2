#!/bin/bash
# Solicitamos un nodo con 64 cores y 256 GB de memoria durante 10 minutos
#SBATCH -n 1 -c 64 -t 00:10:00 --mem=256G
...
for i in {1..25}; do
    for N in 500 750 1000 1500 2000 3000 3500; do
        ...
        for C in 2 4 8 16 32 64 128 256; do
            # Ejercicio 4 o0
            F6=`./p24o0 $N $C`
            printf "4o0,%4d,%3d,%14.2lf\n" $N $C $F6

            # Ejercicio 4 o2
            F7=`./p24o2 $N $C`
            printf "4o2,%4d,%3d,%14.2lf\n" $N $C $F7
        done
    done
done
